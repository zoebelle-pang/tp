...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        VALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_GRADE, VALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_nullGrade_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_invalidSubject_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        INVALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_nullSubject_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_GRADE, null, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_invalidAttendance_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        VALID_SUBJECT, INVALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_invalidPayment_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        VALID_SUBJECT, VALID_ATTENDANCE, INVALID_PAYMENT, VALID_NOTE, VALID_DATETIME, VALID_TAGS);
    ...
    public void toModelType_invalidDateTimes_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        VALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, invalidDateTimes, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_GRADE,
                        VALID_SUBJECT, VALID_ATTENDANCE, VALID_PAYMENT, VALID_NOTE, VALID_DATETIME, invalidTags);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
